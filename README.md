...
**Typescript Starter** is a `Typescript` + `Express` + `Node` starter kit to develop `REST API` server apps.
...
- Fork or Use [this](https://github.com/luanelioliveira/typescript-starter/generate) template repository.
...
> Make sure you already have [`node.js`](https://github.com/luanelioliveira/typescript-starter#prerequisites) and [`npm`](https://github.com/luanelioliveira/typescript-starter#prerequisites) or [`yarn`](https://github.com/luanelioliveira/typescript-starter#prerequisites) installed in your system.
...
> Check [`package.json`](https://github.com/luanelioliveira/typescript-starter/blob/master/package.json) to see more "scripts"
